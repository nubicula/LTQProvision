package com.leonteq.web.rest;

import com.leonteq.LtqProvisionApp;

import com.leonteq.domain.VirtualVolume;
import com.leonteq.repository.VirtualVolumeRepository;
import com.leonteq.web.rest.errors.ExceptionTranslator;
...
import static com.leonteq.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = LtqProvisionApp.class)
public class VirtualVolumeResourceIntTest {
    ...
    private static final Boolean UPDATED_REPLICATED = true;
    ...
    public void createVirtualVolume() throws Exception {
        ...
        assertThat(testVirtualVolume.isReplicated()).isEqualTo(DEFAULT_REPLICATED);
    }
    ...
    public void getAllVirtualVolumes() throws Exception {
        ...
        restVirtualVolumeMockMvc.perform(get("/api/virtual-volumes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].replicated").value(hasItem(DEFAULT_REPLICATED.booleanValue())));
    }
    ...
    public void getVirtualVolume() throws Exception {
        ...
        restVirtualVolumeMockMvc.perform(get("/api/virtual-volumes/{id}", virtualVolume.getId()))
            ...
            .andExpect(jsonPath("$.replicated").value(DEFAULT_REPLICATED.booleanValue()));
    }
    @Test
    @Transactional
    ...
    public void updateVirtualVolume() throws Exception {
        ...
        assertThat(testVirtualVolume.isReplicated()).isEqualTo(UPDATED_REPLICATED);
    }
