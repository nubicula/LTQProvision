...
export class VirtualVolumeResolve implements Resolve<IVirtualVolume> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).pipe(map((virtualVolume: HttpResponse<VirtualVolume>) => virtualVolume.body));
        }
        return of(new VirtualVolume());
    }
}
...
export const virtualVolumeRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'ltqProvisionApp.virtualVolume.home.title'
        },
