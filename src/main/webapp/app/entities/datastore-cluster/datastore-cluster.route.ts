...
export class DatastoreClusterResolve implements Resolve<IDatastoreCluster> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).pipe(map((datastoreCluster: HttpResponse<DatastoreCluster>) => datastoreCluster.body));
        }
        return of(new DatastoreCluster());
    }
}
...
export const datastoreClusterRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'ltqProvisionApp.datastoreCluster.home.title'
        },
