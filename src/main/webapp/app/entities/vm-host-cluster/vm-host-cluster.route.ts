...
export class VMHostClusterResolve implements Resolve<IVMHostCluster> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).pipe(map((vMHostCluster: HttpResponse<VMHostCluster>) => vMHostCluster.body));
        }
        return of(new VMHostCluster());
    }
}
...
export const vMHostClusterRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'ltqProvisionApp.vMHostCluster.home.title'
        },
