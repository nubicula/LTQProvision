...
export class StorageArrayResolve implements Resolve<IStorageArray> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).pipe(map((storageArray: HttpResponse<StorageArray>) => storageArray.body));
        }
        return of(new StorageArray());
    }
}
...
export const storageArrayRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'ltqProvisionApp.storageArray.home.title'
        },
